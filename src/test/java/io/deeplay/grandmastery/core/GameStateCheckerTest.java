...
class GameStateCheckerTest {
  ...
  void isDrawTestWithKings() {
    ...
    var move = LongAlgebraicNotationParser.getMoveFromString("e4e5");
  ...
  void isStaleMateTest() {
    ...
    var move = LongAlgebraicNotationParser.getMoveFromString("h5h6");
    new King(Color.WHITE).move(board, move);
  ...
  void isNotStaleMateTest() {
    ...
    var move = LongAlgebraicNotationParser.getMoveFromString("h4h5");
    new King(Color.WHITE).move(board, move);
